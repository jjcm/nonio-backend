...
func TestWeCanGetTheParentIDsFromAListOfComments(t *testing.T) {
	...
	topLevelComment4, _ := person.CommentOnPost(post, nil, "text")
	topLevelComment5, _ := person.CommentOnPost(post, nil, "text")
	...
	childofComment1_1, _ := person.CommentOnPost(post, &topLevelComment1, "i'm a child")
	childofComment1_2, _ := person.CommentOnPost(post, &topLevelComment1, "i'm a child")
	childofComment1_3, _ := person.CommentOnPost(post, &topLevelComment1, "i'm a child")
	childofComment2_1, _ := person.CommentOnPost(post, &topLevelComment2, "i'm a child")
	childofComment3_1, _ := person.CommentOnPost(post, &topLevelComment3, "i'm a child")
	// reset comments
	comments = []Comment{
		childofComment1_1,
		childofComment1_2,
